...
| Metric/Points Awarded per Status | 0 Points | 1 Point | 2 Points | 3 Points | 4 Points |
|---|---|---|---|---|---|
| Collateral Coverage Ratio | <1 | 1-2 | >2 | --- | --- |
| TLR | >5 | 3-5 | <3 | --- | --- |
| SDLR | >4 | 3-4 | 2-3 | <2 | --- |
...
The data that was used for this project contained missing information pertinent to the calculation of several variables; as such, the sample results provided displays multiple missing values. For this example, whenever a missing value is encountered, it is treated as 0. The metrics used to determine the creditworthiness were taken to be applied in the most general sense; in reality, some values and their indication of a business's health is sensitive to the industry it's a part of. This resulted in the exclusion of loan pricing sensitivity in the calculation of creditworthiness. When the data was simulated, the numbers produced were randomized, meaning that the value of a certain quantity is independent to other variables. Despite the limitations of the simulated data, this framework provides a reproducible method of obtaining key information about a client's creditworthiness.
